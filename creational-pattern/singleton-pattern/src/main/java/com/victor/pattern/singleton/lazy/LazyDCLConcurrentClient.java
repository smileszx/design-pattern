 ...
 **/
public class LazyDCLConcurrentClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(LazyDCLConcurrentClient.class);
    ...
    static class InitLoadBalancer implements Runnable {
        ...
        @Override
        public void run() {
            LazySingletonLoadBalancer loadBalancer = LazySingletonLoadBalancer.getLoadBalancer();
