 ...
 **/
public class EagerConcurrentClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(EagerConcurrentClient.class);
    ...
    static class InitLoadBalancer implements Runnable {
        ...
        @Override
        public void run() {
            EagerSingletonLoadBalancer loadBalancer = EagerSingletonLoadBalancer.getLoadBalancer();
