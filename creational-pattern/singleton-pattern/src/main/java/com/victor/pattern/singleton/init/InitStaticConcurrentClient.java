 ...
 **/
public class InitStaticConcurrentClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(InitStaticConcurrentClient.class);
    ...
    static class InitLoadBalancer implements Runnable {
        ...
        @Override
        public void run() {
            InitDemandHolderLoadBalancer loadBalancer = InitDemandHolderLoadBalancer.getLoadBalancer();
